...
export const metadata: Metadata = {
  title: "Terms of Service — HR Tools Nav",
  description:
    "Read the Terms of Service for HR Tools Nav. By using our directory platform, you agree to these terms governing your use of the website and services.",
};
        ...
        <div className="space-y-8 text-[#8BA3BE] leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              content — are owned by HR Tools Nav and are protected by international
          ...
          <section>
            ...
            <p className="mb-3">
              ...
              of HR Tools Nav. We reserve the right to moderate, edit, or remove reviews
          ...
          <section>
            ...
            <p>
              HR Tools Nav offers free access to our directory and comparison features.
