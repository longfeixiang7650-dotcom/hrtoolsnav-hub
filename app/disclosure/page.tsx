...
export const metadata: Metadata = {
  title: "Affiliate Disclosure — HR Tools Nav",
  description:
    "HR Tools Nav's affiliate disclosure policy. Learn how we may earn commissions through partner links on our site.",
};
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-6 text-stone-500 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">Transparency First</h2>
            <p>
              HR Tools Nav is committed to transparency. This Affiliate Disclosure
              explains how we may earn compensation through links on our website.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">Affiliate Links</h2>
            <p>
              Some of the links on HR Tools Nav are affiliate links. This means that
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">No Impact on Rankings</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">Partners</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">Questions</h2>
            <p>
              If you have any questions about our affiliate relationships or this
              disclosure, please contact us at{" "}
              <a href="mailto:info@hrtoolsnav.net" className="text-[#3B82F6] hover:underline">
                info@hrtoolsnav.net
              </a>
              .
            </p>
