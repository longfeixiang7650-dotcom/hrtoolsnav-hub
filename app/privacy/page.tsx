...
export const metadata: Metadata = {
  title: "Privacy Policy — HR Tools Nav",
  description:
    "Learn how HR Tools Nav collects, uses, and protects your personal data. Our privacy policy outlines our commitment to your privacy and data security.",
};
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-stone-500 leading-relaxed">
          <section>
            ...
            <p>
              HR Tools Nav ("we," "our," or "us") is committed to protecting your privacy.
              This Privacy Policy explains how we collect, use, disclose, and safeguard your
              information when you visit our website hrtoolsnav.net (the "Site"). Please read this
          ...
          <section>
            ...
            <h3 className="text-lg font-semibold text-stone-900 mb-2">Personal Data</h3>
            <p className="mb-3">
            ...
            <h3 className="text-lg font-semibold text-stone-900 mb-2">Automatically Collected Data</h3>
            <p className="mb-3">
            ...
            <h3 className="text-lg font-semibold text-stone-900 mb-2">Cookies and Tracking Technologies</h3>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">4. Information Sharing and Disclosure</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">5. Cookie Policy</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">6. Your Rights (GDPR & CCPA)</h2>
            <p className="mb-3">
            ...
            <p className="mt-3">
              To exercise any of these rights, please contact us at privacy@hrtoolsnav.net. We
              will respond to your request within 30 days.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">7. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">8. Third-Party Links</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">9. Children's Privacy</h2>
            <p>
              ...
              us at privacy@hrtoolsnav.net.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">10. International Data Transfers</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">11. Changes to This Policy</h2>
            <p>
          ...
          <section>
            ...
            <div className="mt-4 p-5 bg-[#0F1D32] border border-[#1E3A5F] rounded-xl">
              <p className="mb-2"><strong className="text-stone-900">Email:</strong> privacy@hrtoolsnav.net</p>
