        ...
        <thead>
          <tr className="bg-[#2a1a4e]">
            {headerRow.map((h, idx) => (
              <th
                key={idx}
                className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider text-[#8B5CF6] border-b border-[#3b2566]"
              >
                {h}
              </th>
            ))}
  ...
  return (
    <div className="relative pt-32 pb-20">
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <Link
          href="/blog"
          className="inline-flex items-center gap-2 text-sm text-[#c4b5fd] hover:text-[#8B5CF6] transition-colors mb-8"
        >
          ...
          <article>
            ...
            <header className="mb-10">
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <span className="text-xs font-semibold uppercase tracking-wider text-[#8B5CF6] bg-[#2a1a4e] px-3 py-1.5 rounded-md">
                  {post.category}
                </span>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#a78bfa] mt-2">
                      Hrtoolsnav-hub independently researches and verifies all product data. Ratings sourced from G2, Capterra, and other trusted review platforms.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12 lg:hidden">
                ...
                <div className="grid gap-4">
                  {relatedPosts.map((rp) => (
                    ...
                    >
                      <h4 className="font-bold text-[#e8e0f7] hover:text-[#8B5CF6] transition-colors text-sm">
                        {rp.title}
                      </h4>
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 space-y-6">
                  ...
                  {post.content
                    ...
                    .map((heading, idx) => (
                      <a
                        key={idx}
                        href={`#`}
                        className="block text-xs text-[#c4b5fd] hover:text-[#8B5CF6] transition-colors"
                      >
                        {heading.replace(/^##\s+/, "")}
                      </a>
                    ))}
                ...
                <div className="bg-[#1a1233] border border-[#3b2566] rounded-xl p-5">
                  ...
                  <div className="space-y-3">
                    {relatedPosts.map((rp) => (
                      ...
                      >
                        <h4 className="text-sm font-bold text-[#c4b5fd] group-hover:text-[#8B5CF6] transition-colors leading-snug">
                          {rp.title}
                        </h4>
                        <p className="text-xs text-[#a78bfa] mt-1">
              ...
              <div className="bg-gradient-to-br from-[#2a1a4e] to-[#1a1233] border border-[#3b2566] rounded-xl p-5 text-center">
                <div className="w-10 h-10 rounded-full bg-[#8B5CF6]/20 flex items-center justify-center mx-auto mb-3">
                ...
                <Link
                  href="/"
                  className="inline-flex items-center gap-1 px-4 py-2 bg-[#8B5CF6] hover:bg-[#8B5CF6] text-white text-xs font-bold rounded-lg transition-colors"
                >
