...
export const metadata: Metadata = {
  title: "Blog — HR Tools Nav",
  description:
    "Expert insights, comparisons, and strategies for choosing and using HR tools. Stay informed with the latest in human resources software.",
};
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-[#8BA3BE] max-w-2xl mx-auto">
            In-depth reviews of HR software, recruitment platforms, and employee management tools. Expert guides to help you build better HR processes.
          </p>
        </div>
